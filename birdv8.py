...
async def read_channel_messages_by_id(channel_id, limit=250, reverse=True):
...
def format_results(results):
    ...
    output += f"Increased 10x (1000%+): {sum(df_sorted['percentage_change'] > 1000)}\n"
    output += f"Increased 5x (400%+): {sum(df_sorted['percentage_change'] > 400) - sum(df_sorted['percentage_change'] > 1000)}\n"
    output += f"Increased 3x (200%+): {sum(df_sorted['percentage_change'] > 200) - sum(df_sorted['percentage_change'] > 400) - sum(df_sorted['percentage_change'] > 1000)}\n"
    output += f"Increased 2x (100%+): {sum(df_sorted['percentage_change'] > 100) - sum(df_sorted['percentage_change'] > 200) - sum(df_sorted['percentage_change'] > 400) - sum(df_sorted['percentage_change'] > 1000)}\n"
